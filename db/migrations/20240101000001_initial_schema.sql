...
DROP INDEX IF EXISTS idx_alerts_tenant_date;
DROP INDEX IF EXISTS idx_alerts_user_status;
DROP INDEX IF EXISTS idx_thresholds_tenant_variant;
DROP INDEX IF EXISTS idx_thresholds_user;
DROP INDEX IF EXISTS idx_snapshots_variant;
DROP INDEX IF EXISTS idx_snapshots_tenant_date;
