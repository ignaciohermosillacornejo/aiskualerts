-- migrate:up
-- Migration 008: Multi-tenant users
...
-- migrate:down
ALTER TABLE alerts DROP CONSTRAINT IF EXISTS fk_alerts_dismissed_by;
ALTER TABLE thresholds DROP CONSTRAINT IF EXISTS fk_thresholds_created_by;
ALTER TABLE sessions DROP CONSTRAINT IF EXISTS fk_sessions_current_tenant;
ALTER TABLE users DROP CONSTRAINT IF EXISTS fk_users_last_tenant;
...
ALTER TABLE alerts DROP COLUMN IF EXISTS dismissed_by;
ALTER TABLE thresholds DROP COLUMN IF EXISTS created_by;
ALTER TABLE sessions DROP COLUMN IF EXISTS current_tenant_id;
ALTER TABLE users DROP COLUMN IF EXISTS last_tenant_id;
ALTER TABLE tenants DROP COLUMN IF EXISTS owner_id;
DROP INDEX IF EXISTS idx_user_tenants_tenant;
DROP INDEX IF EXISTS idx_user_tenants_user;
